            ...
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="bg-cream">
                  <th className="px-6 py-4 text-sm font-semibold uppercase tracking-wide text-muted">Visit</th>
                  <th className="px-6 py-4 text-sm font-semibold uppercase tracking-wide text-muted">Price</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-line">
                {PRICED_VISITS.map((v) => (
                  <tr key={v}>
                    ...
                    <td className="px-6 py-5 font-heading text-2xl font-bold text-navy">{priceRange(v)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-start">
            <div>
              ...
              <p className="mt-4 max-w-md text-lg leading-relaxed text-muted">
                The host is responsible for the total group fee. Your complete total is shown before booking.
              </p>
              <div className="mt-6"><CTAButton href="/book?start=group">Book a Group Visit</CTAButton></div>
            </div>
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-line bg-white p-6">
                <p className="font-heading text-3xl font-bold text-navy">${GROUP_VISIT_TRAVEL_FEE.standard}–${GROUP_VISIT_TRAVEL_FEE.premium}</p>
        ...
        <Container>
          <div className="grid gap-8 sm:grid-cols-2">
            <Callout title="Payment">
              <p className="text-base leading-relaxed text-muted">Cash, check, credit card, HSA/FSA and Venmo are accepted.</p>
            </Callout>
          ...
          <div id="cancellation-policy" className="mt-8 scroll-mt-24">
            <Callout title="Cancellation & Rescheduling Policy">
              <p className="text-base leading-relaxed text-muted">
                Please provide at least 24 hours&apos; notice if you need to cancel or reschedule an appointment.
                Cancellations, no-shows, or same-day changes made with less than 24 hours&apos; notice are subject
                to a $50 fee. For Group Visits, the $50 fee applies once to the entire booking, and the host is
                responsible for the fee. We understand that emergencies and unexpected circumstances happen;
                exceptions may be made at the discretion of GoChiroMobile.
              </p>
            </Callout>
          </div>

          <div className="mt-8"><CTAButton href="/book-online">Schedule a visit →</CTAButton></div>
        </Container>
      </Section>
    </div>
  );
